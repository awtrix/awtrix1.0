...
class FacebookApp : public IApplication
{
    private:
        ...
        const String url = "/205403270192886?access_token=413044212451682|1b83bfa010904e1a18267c5845f59efe&fields=fan_count"; 
        const int httpsPort = 443; 
        const char* fingerprint = "bd258c1f62a4a6d9cf7d9812d22e2ff57e84fb36";
